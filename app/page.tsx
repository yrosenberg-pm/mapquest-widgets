        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="relative z-50" ref={menuRef}>
            <button
              ...
              className="flex items-center gap-2 md:gap-3 px-3 md:px-4 py-2 md:py-2.5 rounded-xl bg-white shadow-lg shadow-gray-200/80 hover:shadow-xl transition-all"
            >
              <Grid3X3 className="w-5 h-5 text-gray-500" />
              <div className="text-left">
                <div className="text-sm font-semibold text-gray-900">{currentWidget?.name}</div>
                <div className="text-xs text-gray-500 hidden md:block">{currentWidget?.description}</div>
              </div>
